...
stack<int>path;
//Function to add edge to the undirected weighted graph
void add_Edge(int u, int v, int weight)
{
	adj[u].push_back(make_pair(v,weight));
	adj[v].push_back(make_pair(u,weight));
}
//Finding the minimum value not yet included in MST
...
//Finding weight between two vertices u and v
...
//Function to do DFS traversal to find the path
...
//Main function to find the minimum spanning tree using Prim's algorithm
