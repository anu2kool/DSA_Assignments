...
//The basic structure to represent the node of the red 
//black tree.
struct Node 
{
    int data; 
...
public:
    node_ptr root;
    node_ptr TNULL;
    //To initialize the red black tree
    ...
    //Fixing the  violations to restore the red black tree property
    void Fix_Violation(node_ptr x) 
	{
        ...
        while (x != root && x->color == 0) 
		{
			...
			else 
			{
                ...
                if (p->right->color == 0 && p->right->color == 0) 
				{
                    p->color = 1;
                    x = x->parent;
                } 
    ...
    //This will fix the violations in the tree
    //after the insertion
...
int main() 
{
    ...
    cin>>Q;
    //There are 4 choices for the queries:
    //1-Insert the value at given index.
    //2-To delete the node at given index from the tree.
    //3-To find the element given the index.
    //4-To find the average given the l and r.
    cout<<"There are 4 choices:"<<endl;
    cout<<"1-Insert the value at given index."<<endl;
    cout<<"2-To delete the node at given index from the tree."<<endl;
    cout<<"3-To find the element given the index."<<endl;
    cout<<"4-To find the average given the l and r."<<endl;
    while(Q--)
	{           
    	cin>>choice;
    	if(choice==1)
